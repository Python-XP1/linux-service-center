...
def print_process_result(result: dict) -> None:
    ...
    if slice_commands:
        ...
        print(
            "  If stopping the unit does not work, its custom slice may still hold "
            "the process."
        )
